...
urlpatterns = [
    ...
    path('subcategory/<int:category_id>/', views.subcategory_view, name='subcategory_view'), # prikaz subkategorija
    path('products/subcategory/<int:subcategory_id>/', views.subcategory_products, name='subcategory_products'),
